...
"use strict";var JM=JM||{};JM.catJargon=function(){function t(){var t=$(window).scrollTop(),i=$(".header-wrap").height();t>3*i?s():$(".toTop").removeClass("visible")}function s(){if(!$(".toTop").hasClass("visible")){var t=$(".content").offset().left+$(".content").width(),s=$("body").width();$(".toTop").css("right",s-t),$(".toTop").addClass("visible")}}function i(t){for(var s=t.split(/[\s\-&]+/),i=[],a=0;a!=s.length;++a){var o=s[a].replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,"");""!=o&&i.push(o)}return i}function a(t){if(t.startsWith("ap"));for(var s=i(t),a="",o=0;o!=s.length;++o)o>0&&(a+=" "),a+=s[o];return a}function o(){var t=$("#txtSearch").val().toLowerCase(),s=a(t);$(".entry").each(function(){for(var t=$(this).find("h2 a").text().toLowerCase(),i=t.split(";"),o=!1,e=0;e!=i.length&&!o;++e){var n=a(i[e]);n.startsWith(s)&&(o=!0)}$(this).find("p.cref a").each(function(){var t=$(this).text().toLowerCase(),i=a(t);i.startsWith(s)&&(o=!0)}),o?$(this).removeClass("hidden"):$(this).addClass("hidden")})}$(document).ready(function(){0!=$("#catjargon").length&&("onhashchange"in window&&(window.onhashchange=function(){var t=window.location.hash.substr(1),s=$("a[name='"+t+"']").closest(".entry");s.addClass("flash"),setTimeout(function(){s.removeClass("flash")},500)}),$(window).scroll(t),t(),$(".toTop").click(function(){document.location.hash=""}),$("#txtSearch").val(""),$("#txtSearch").bind("input",o),""==window.location.hash&&setTimeout(function(){$("#txtSearch").focus()},50),$("#toggleDisclaimer").click(function(){$(".disclaimer").hasClass("visible")?$(".disclaimer").removeClass("visible"):$(".disclaimer").addClass("visible")}),$("#toggleTOC").click(function(){$(".glossary-toc").hasClass("visible")?$(".glossary-toc").removeClass("visible"):$(".glossary-toc").addClass("visible")}),buildTOC())})}();
