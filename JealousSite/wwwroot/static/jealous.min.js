...
"use strict";var JM=JM||{};JM.locaQuiz=function(){var a="",e=0;$(document).ready(function(){if(0!=$("#localizationQuiz").length){var s=1;$(".start").click(function(){$(".start").addClass("hidden"),$(".qpage[data-qix='1']").addClass("active"),$("p.lede").css("display","none"),ga("send",{hitType:"event",eventCategory:"locaquiz",eventAction:"locaquiz-start",eventValue:s})}),$(".option").click(function(){var a=$(this).closest(".qpage");a.hasClass("solved")||(a.addClass("solved"),$(this).hasClass("correct")?a.addClass("correct"):a.addClass("false"),$(this).addClass("chosen"))}),$(".continue").click(function(){var s=$(this).closest(".qpage");s.removeClass("active");var t=s.find(".option.chosen"),i=t.data("ox"),c="N";t.hasClass("correct")&&(++e,c="Y");var n=s.data("qix")+1;n>2&&(a+="!"),a+=c+"-"+i,n<=10?$(".qpage[data-qix='"+n+"']").addClass("active"):($("#localizationQuiz .result").addClass("visible"),ga("send",{hitType:"event",eventCategory:"locaquiz",eventAction:"locaquiz-finish",eventValue:e+"#"+a}))})}})}();