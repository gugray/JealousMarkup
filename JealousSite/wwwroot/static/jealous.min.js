...
"use strict";var JM=JM||{};JM.catJargon=function(){function t(){var t=$(window).scrollTop(),s=$(".header-wrap").height();t>3*s?i():$(".toTop").removeClass("visible")}function i(){if(!$(".toTop").hasClass("visible")){var t=$(".content").offset().left+$(".content").width(),i=$("body").width();$(".toTop").css("right",i-t),$(".toTop").addClass("visible")}}function s(t){for(var i=t.split(/[\s\-&]+/),s=[],a=0;a!=i.length;++a){var o=i[a].replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,"");""!=o&&s.push(o)}return s}function a(t){if(t.startsWith("ap"));for(var i=s(t),a="",o=0;o!=i.length;++o)o>0&&(a+=" "),a+=i[o];return a}function o(){var t=$("#txtSearch").val().toLowerCase(),i=a(t);$(".entry").each(function(){for(var t=$(this).find("h2 a").text().toLowerCase(),s=t.split(";"),o=!1,e=0;e!=s.length&&!o;++e){var n=a(s[e]);n.startsWith(i)&&(o=!0)}$(this).find("p.cref a").each(function(){var t=$(this).text().toLowerCase(),s=a(t);s.startsWith(i)&&(o=!0)}),o?$(this).removeClass("hidden"):$(this).addClass("hidden")})}$(document).ready(function(){0!=$("#catjargon").length&&("onhashchange"in window&&(window.onhashchange=function(){var t=window.location.hash.substr(1),i=$("a[name='"+t+"']").closest("h2");i.addClass("flash"),setTimeout(function(){i.removeClass("flash")},500)}),$(window).scroll(t),t(),$(".toTop").click(function(){document.location.hash=""}),$("#txtSearch").val(""),$("#txtSearch").bind("input",o),""==window.location.hash&&setTimeout(function(){$("#txtSearch").focus()},50),$("#toggleDisclaimer").click(function(){$(".disclaimer").hasClass("visible")?$(".disclaimer").removeClass("visible"):$(".disclaimer").addClass("visible")}))})}();
