...
var JM=JM||{};JM.catJargon=function(){"use strict";function e(){var e,s=$(window).scrollTop();3*$(".header-wrap").height()<s?$(".toTop").hasClass("visible")||(e=$(".content").offset().left+$(".content").width(),s=$("body").width(),$(".toTop").css("right",s-e),$(".toTop").addClass("visible")):$(".toTop").removeClass("visible")}function l(e){e.startsWith("ap");for(var s=function(e){for(var s=e.split(/[\s\-&]+/),t=[],a=0;a!=s.length;++a){var l=s[a].replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,"");""!=l&&t.push(l)}return t}(e),t="",a=0;a!=s.length;++a)0<a&&(t+=" "),t+=s[a];return t}$(document).ready(function(){var t;0!=$("#catjargon").length&&("onhashchange"in window&&(window.onhashchange=function(){var e=window.location.hash.substr(1),s=$("a[name='"+e+"']").closest(".entry");s.addClass("flash"),setTimeout(function(){s.removeClass("flash")},500)}),$(window).scroll(e),e(),$(".toTop").click(function(){document.location.hash=""}),$("#txtSearch").val(""),$("#txtSearch").bind("input",function(){var a;$(".disclaimer").removeClass("visible"),$("#toggleDisclaimer").removeClass("selected"),$(".glossary-toc").removeClass("visible"),$("#toggleTOC").removeClass("selected"),a=l($("#txtSearch").val().toLowerCase()),$(".entry").each(function(){for(var e=$(this).find("h2 a").text().toLowerCase().split(";"),s=!1,t=0;t!=e.length&&!s;++t)l(e[t]).startsWith(a)&&(s=!0);$(this).find("p.cref a").each(function(){l($(this).text().toLowerCase()).startsWith(a)&&(s=!0)}),s?$(this).removeClass("hidden"):$(this).addClass("hidden")})}),""==window.location.hash&&setTimeout(function(){$("#txtSearch").focus()},50),$("#toggleDisclaimer").click(function(e){$(".disclaimer").hasClass("visible")?($(".disclaimer").removeClass("visible"),$("#toggleDisclaimer").removeClass("selected")):($(".disclaimer").addClass("visible"),$(this).addClass("selected"),$(".glossary-toc").removeClass("visible"),$("#toggleTOC").removeClass("selected")),e.preventDefault()}),$("#toggleTOC").click(function(e){$(".glossary-toc").hasClass("visible")?($(".glossary-toc").removeClass("visible"),$("#toggleTOC").removeClass("selected")):($(".disclaimer").removeClass("visible"),$("#toggleDisclaimer").removeClass("selected"),$(".glossary-toc").addClass("visible"),$(this).addClass("selected")),e.preventDefault()}),t="",$(".entry h2 a").each(function(){var e=$(this).text(),s=$(this).attr("name");""!=t&&(t+="&nbsp;&bull; "),t+="<a href='#"+s+"'>"+e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")+"</a>"}),$(".glossary-toc").html(t))})}();
...
var JM=JM||{};JM.locaQuiz=function(){"use strict";var o="",i=0;$(document).ready(function(){var a;0!=$("#localizationQuiz").length&&((a=localStorage.getItem("locaQuizCount"))||(a=1,localStorage.setItem("locaQuizCount",a)),$(".start").click(function(){$(".start").addClass("hidden"),$(".qpage[data-qix='1']").addClass("active"),$("p.lede").css("display","none"),ga("send",{hitType:"event",eventCategory:"locaquiz",eventAction:"locaquiz-start",eventValue:a}),++a,localStorage.setItem("locaQuizCount",a)}),$(".option").click(function(){var a=$(this).closest(".qpage");a.hasClass("solved")||(a.addClass("solved"),$(this).hasClass("correct")?a.addClass("correct"):a.addClass("false"),$(this).addClass("chosen"))}),$(".continue").click(function(){var a=$(this).closest(".qpage");a.removeClass("active");var e=a.find(".option.chosen"),t=e.data("ox"),s="N";e.hasClass("correct")&&(++i,s="Y");a=a.data("qix")+1;2<a&&(o+="!"),o+=s+"-"+t,a<=10?$(".qpage[data-qix='"+a+"']").addClass("active"):($("#localizationQuiz .result").addClass("visible"),a="You are<br /> AWESOME",i<3?a="GREAT!<br/>But you're not from this industry,<br/>are you?":i<7&&(a="Not too shabby<br/>AT ALL!"),$(".result .awesome").html(a),$("#locaQuizScore").text(i),ga("send",{hitType:"event",eventCategory:"locaquiz",eventAction:"locaquiz-finish",eventLabel:o,eventValue:i}))}))})}();
var JM=JM||{};JM.lspKeywords=function(){"use strict";var n=["#f9bd4e","#50cea8","#a6d5e8","#c493ff","#e1708c","#3eabb4"],l={},a=0,t=0;function e(){var e,s;$(".lspWalkStep").removeClass("visible"),6!=t?($(".lspWalkStep.step"+t).addClass("visible"),$(".lspKeyWalker").addClass("visible"),0==t?($(".walkCommands .next").text("Next"),$(".walkCommands .close").text("Close")):5==t&&($(".walkCommands .next").text("Finish"),$(".walkCommands .close").text("")),$("#lspKeyViz").hasClass("large")?0==t?($(".lspKeyWalker").css("top","10rem"),$(".lspKeyWalker").css("left","4rem"),$(".lspKeyWalker").css("right","")):1==t?($(".lspKeyWalker").css("top","2.5rem"),$(".lspKeyWalker").css("left","2rem")):2==t?($(".lspKeyWalker").css("top","6rem"),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right","2rem")):5==t&&($(".lspKeyWalker").css("top","2.5rem"),$(".lspKeyWalker").css("left","17rem"),$(".lspKeyWalker").css("right","")):(e=null,0==t?(s=$("#lspKeyChart").position().top+120,$(".lspKeyWalker").css("top",s),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right",""),(e=$(".lspKeyWalker").offset()).top-=140):1==t?(s=$("#lspKeyChart").position().top+5,$(".lspKeyWalker").css("top",s),$(".lspKeyWalker").css("left","100px")):2==t?(s=$("#lspKeyLegend").position().top,$(".lspKeyWalker").css("top",s+100),$(".lspKeyWalker").css("left","50px"),(e=$(".lspKeyWalker").offset()).top-=140):5==t&&(s=$("#lspKeyChart").position().top+5,$(".lspKeyWalker").css("top",s),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right","20px"),(e=$(".lspKeyWalker").offset()).top-=140),e&&$("html, body").animate({scrollTop:e.top-100,scrollLeft:e.left}))):$(".lspKeyWalker").removeClass("visible")}function o(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function s(e){!function(e){for(var s="",t=0;t!=e.length;++t){var l=e[t];s+="<div class='cluster"+t+" cluster'>",s+="<span class='label'>",s+="Cluster "+"ABCDEF"[t]+": "+l.sites.length,s+="</span> ",s+="<b>"+o(l.words)+"</b>",s+="<br/><i>";for(var a=0;a!=l.data.length;++a){var r=l.data[a];0!=a&&(s+=", "),s+="<u>"+(r.rank+1)+"</u>&nbsp;",s+=o(r.url)}s+="</i>",s+="</div>"}$("#lspKeyLegend").html(s)}(e);var s={datasets:function(e){for(var s=[],t=0;t!=e.length;++t){for(var l={data:[],backgroundColor:n[t],hoverBackgroundColor:n[t]},a=e[t].data,r=0;r!=a.length;++r){var o=a[r];l.data.push({x:o.x,y:o.y,r:20-Math.round(o.rank/3),tooltip:o.url})}s.push(l)}return s}(e)},e=document.getElementById("lsp-keychart-canvas").getContext("2d");window.lspKeyChart=new Chart(e,{type:"bubble",data:s,options:{responsive:!0,maintainAspectRatio:!1,scales:{xAxes:[{display:!1}],yAxes:[{display:!1}]},legend:{display:!1},tooltips:{callbacks:{label:function(e,s){return s.datasets[e.datasetIndex].data[e.index].tooltip}}},hover:{onHover:function(e){var s;e&&e.length&&0!=e.length?(s=e[0]._datasetIndex,e=e[0]._index,$(".cluster"+s+" u:nth-child("+(e+1)+")").addClass("hilite")):$(".cluster u").removeClass("hilite")}}}})}function r(){var e="stemmed"==$("#stem").text()?"stem-":"nostem-";$("#clust2").hasClass("selected")?e+="2":$("#clust3").hasClass("selected")?e+="3":$("#clust4").hasClass("selected")?e+="4":$("#clust5").hasClass("selected")?e+="5":e+="6",$("#lspKeyChart canvas").remove(),$("#lspKeyChart").html("<canvas id='lsp-keychart-canvas'></canvas>"),s(l[e])}function c(){r(),$(".ctrl-left").click(function(e){$(".ctrl-left").removeClass("selected"),$(this).addClass("selected"),r(),e.preventDefault()}),$(".ctrl-right").click(function(e){"stemmed"==$(this).text()?$(this).text("surface"):$(this).text("stemmed"),r(),e.preventDefault()})}function i(e,s){var t=new XMLHttpRequest;t.open("GET",e,!0),t.onreadystatechange=function(){4===this.readyState&&200===this.status&&(l[s]=JSON.parse(t.responseText),0==--a&&c())},t.send()}$(document).ready(function(){0!=$("#lspKeyViz").length&&(a=11,i("/files/lsp-keywords/data-stem-6.json","stem-6"),i("/files/lsp-keywords/data-stem-5.json","stem-5"),i("/files/lsp-keywords/data-stem-4.json","stem-4"),i("/files/lsp-keywords/data-stem-3.json","stem-3"),i("/files/lsp-keywords/data-stem-2.json","stem-2"),i("/files/lsp-keywords/data-nostem-6.json","nostem-6"),i("/files/lsp-keywords/data-nostem-5.json","nostem-5"),i("/files/lsp-keywords/data-nostem-4.json","nostem-4"),i("/files/lsp-keywords/data-nostem-3.json","nostem-3"),i("/files/lsp-keywords/data-nostem-2.json","nostem-2"),$.ajax({type:"GET",url:"/static/lib/chart-2.1.6.min.js",success:function(){0==--a&&c()},dataType:"script",cache:!1}),$(".ctrl-minimize").click(function(){$("#lspKeyViz").removeClass("large"),$("body").css("overflow-y","scroll"),$("#lspKeyChart canvas").css("height","17rem"),$(".lspKeyWalker").removeClass("visible")}),$(".enlarge").click(function(){$("#lspKeyViz").addClass("large"),$("body").css("overflow-y","hidden"),$("#lspKeyChart canvas").css("height","100% !important"),$(".lspKeyWalker").removeClass("visible")}),$(".walkthrough").click(function(){$(".lspKeyWalker").hasClass("visible")?$(".lspKeyWalker").removeClass("visible"):(t=0,e())}),$(".walkCommands .next").click(function(){++t,e()}),$(".walkCommands .close").click(function(){$(".lspKeyWalker").removeClass("visible")}))})}();
var JM=JM||{};JM.nmt=function(){"use strict";function s(e){$(".nmtBlock .xl").addClass("meta"),$("#xlStraight").text(e||"Regular translation"),$("#xlCrazy").text(e||"Translation from garbled model")}$(document).ready(function(){$(".nmtHeader .button").click(function(){var e;$(this).hasClass("disabled")||(new Date,e=$.ajax({url:"https://mtserv.kginno.tk/xlate",type:"POST",contentType:"application/x-www-form-urlencoded; charset=UTF-8",data:{src:$("#txtInput").val()}}),$(".nmtHeader .button").addClass("disabled"),$(".nmtHeader i").addClass("visible"),s(),e.done(function(e){var t;$(".nmtHeader .button").removeClass("disabled"),$(".nmtHeader i").removeClass("visible"),"ok"==e.status?($("#xlStraight").text(e.real.tgt),$("#xlStraight").removeClass("meta"),t=e.real_sec.toFixed(2)+"s; "+e.real.pred_score.toFixed(2),$("#xlStraight").append("<div class='xlstats'>"+t+"</div>"),$("#xlCrazy").text(e.crazy.tgt),$("#xlCrazy").removeClass("meta"),t=e.crazy_sec.toFixed(2)+"s; "+e.crazy.pred_score.toFixed(2),$("#xlCrazy").append("<div class='xlstats'>"+t+"</div>")):s("** The server is overloaded. Please try again in a bit. **")}),e.fail(function(e,t,a){$(".nmtHeader .button").removeClass("disabled"),$(".nmtHeader i").removeClass("visible"),s("** Sorry; the service seems to be unavailable right now. **")}))})})}();