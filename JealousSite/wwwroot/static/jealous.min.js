...
"use strict";var JM=JM||{};JM.site=function(){function e(){if($(".catSelector span.primary").hasClass("selected"))return void $(".toc-item").removeClass("hidden");var e={};$(".catSelector span.selected").each(function(){e[$(this).text()]=!0}),$(".toc-item").each(function(){var s=[];$(this).find(".filedunder span").each(function(){s.push($(this).text())});for(var t=!1,a=0;a!=s.length;++a){var c=s[a];if(e.hasOwnProperty(c)){t=!0;break}}t?$(this).removeClass("hidden"):$(this).addClass("hidden")})}$(document).ready(function(){$(".catSelector span").click(function(){$(this).hasClass("primary")?($(".catSelector span").removeClass("selected"),$(this).addClass("selected")):$(".catSelector span.primary").hasClass("selected")?($(".catSelector span.primary").removeClass("selected"),$(this).addClass("selected")):$(this).hasClass("selected")?$(".catSelector span.selected").length>1&&$(this).removeClass("selected"):$(this).addClass("selected"),e()})})}();