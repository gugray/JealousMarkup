...
"use strict";var JM=JM||{};JM.locaQuiz=function(){var a="",s=0;$(document).ready(function(){0!=$("#localizationQuiz").length&&($(".start").click(function(){$(".start").addClass("hidden"),$(".qpage[data-qix='1']").addClass("active"),$("p.lede").css("display","none")}),$(".option").click(function(){var a=$(this).closest(".qpage");a.hasClass("solved")||(a.addClass("solved"),$(this).hasClass("correct")?a.addClass("correct"):a.addClass("false"),$(this).addClass("chosen"))}),$(".continue").click(function(){var t=$(this).closest(".qpage");t.removeClass("active");var c=t.find(".option.chosen"),i=c.data("ox"),e="N";c.hasClass("correct")&&(++s,e="Y"),a+="!"+e+"-"+i;var d=t.data("qix")+1;$(".qpage[data-qix='"+d+"']").addClass("active")}))})}();