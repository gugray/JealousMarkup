...
"use strict";var JM=JM||{};JM.lspKeywords=function(){function e(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function s(e){for(var s=[],t=0;t!=e.length;++t){for(var a={data:[],backgroundColor:r[t],hoverBackgroundColor:r[t]},l=e[t].data,n=0;n!=l.length;++n){var o=l[n];a.data.push({x:o.x,y:o.y,r:20-Math.round(o.rank/3),tooltip:o.url})}s.push(a)}return s}function t(s){for(var t="ABCDEF",a="",l=0;l!=s.length;++l){var n=s[l];a+="<div class='cluster"+l+"'>",a+="<span class='label'>",a+="Cluster "+t[l]+": "+(n.sites.length+1),a+="</span> ",a+="<b>"+e(n.words)+"</b>",a+="<br/><i>";for(var o=0;o!=n.data.length;++o){var r=n.data[o];0!=o&&(a+=", "),a+="<u>"+(r.rank+1)+"</u>&nbsp;",a+=e(r.url)}a+="</i>",a+="</div>"}$("#lspKeyLegend").html(a)}function a(e){t(e);var a={datasets:s(e)},l=document.getElementById("lsp-keychart-canvas").getContext("2d");window.lspKeyChart=new Chart(l,{type:"bubble",data:a,options:{responsive:!0,scales:{xAxes:[{display:!1}],yAxes:[{display:!1}]},legend:{display:!1},tooltips:{callbacks:{label:function(e,s){var t=s.datasets[e.datasetIndex],a=t.data[e.index];return a.tooltip}}}}})}function l(){var e;e="stemmed"==$("#stem").text()?"stem-":"nostem-",e+=$("#clust2").hasClass("selected")?"2":$("#clust3").hasClass("selected")?"3":$("#clust4").hasClass("selected")?"4":$("#clust5").hasClass("selected")?"5":"6",$("#lspKeyChart canvas").remove(),$("#lspKeyChart").html("<canvas id='lsp-keychart-canvas'></canvas>"),a(d[e])}function n(){l(),$(".ctrl-left").click(function(e){$(".ctrl-left").removeClass("selected"),$(this).addClass("selected"),l(),e.preventDefault()}),$(".ctrl-right").click(function(e){"stemmed"==$(this).text()?$(this).text("surface"):$(this).text("stemmed"),l(),e.preventDefault()})}function o(e,s){var t=new XMLHttpRequest;t.open("GET",e,!0),t.onreadystatechange=function(){4===this.readyState&&200===this.status&&(d[s]=JSON.parse(t.responseText),--c,0==c&&n())},t.send()}var r=["#f9bd4e","#50cea8","#a6d5e8","#c493ff","#e1708c","#3eabb4"],d={},c=0;$(document).ready(function(){0!=$("#lspKeyChart").length&&(c=10,o("/files/lsp-keywords/data-stem-6.json","stem-6"),o("/files/lsp-keywords/data-stem-5.json","stem-5"),o("/files/lsp-keywords/data-stem-4.json","stem-4"),o("/files/lsp-keywords/data-stem-3.json","stem-3"),o("/files/lsp-keywords/data-stem-2.json","stem-2"),o("/files/lsp-keywords/data-nostem-6.json","nostem-6"),o("/files/lsp-keywords/data-nostem-5.json","nostem-5"),o("/files/lsp-keywords/data-nostem-4.json","nostem-4"),o("/files/lsp-keywords/data-nostem-3.json","nostem-3"),o("/files/lsp-keywords/data-nostem-2.json","nostem-2"))})}();