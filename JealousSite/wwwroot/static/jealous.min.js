...
"use strict";var JM=JM||{};JM.site=function(){function l(){var l=$("html").innerWidth();$(".debug").html("Wnd: "+l),l>=800?($("html").removeClass("smaller"),$("html").removeClass("mobile")):l>=620&&l<800?($("html").addClass("smaller"),$("html").removeClass("mobile")):($("html").addClass("smaller"),$("html").addClass("mobile"))}$(document).ready(function(){$(window).resize(l),l()})}();