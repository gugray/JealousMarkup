...
var JM=JM||{};JM.catJargon=function(){"use strict";function e(){var e=$(window).scrollTop(),t=$(".header-wrap").height();e>3*t?s():$(".toTop").removeClass("visible")}function s(){if(!$(".toTop").hasClass("visible")){var e=$(".content").offset().left+$(".content").width(),s=$("body").width();$(".toTop").css("right",s-e),$(".toTop").addClass("visible")}}function t(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function a(){var e="";$(".entry h2 a").each(function(){var s=$(this).text(),a=$(this).attr("name");""!=e&&(e+="&nbsp;&bull; "),e+="<a href='#"+a+"'>"+t(s)+"</a>"}),$(".glossary-toc").html(e)}function i(e){for(var s=e.split(/[\s\-&]+/),t=[],a=0;a!=s.length;++a){var i=s[a].replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g,"");""!=i&&t.push(i)}return t}function o(e){if(e.startsWith("ap"));for(var s=i(e),t="",a=0;a!=s.length;++a)a>0&&(t+=" "),t+=s[a];return t}function l(){var e=$("#txtSearch").val().toLowerCase(),s=o(e);$(".entry").each(function(){for(var e=$(this).find("h2 a").text().toLowerCase(),t=e.split(";"),a=!1,i=0;i!=t.length&&!a;++i){var l=o(t[i]);l.startsWith(s)&&(a=!0)}$(this).find("p.cref a").each(function(){var e=$(this).text().toLowerCase(),t=o(e);t.startsWith(s)&&(a=!0)}),a?$(this).removeClass("hidden"):$(this).addClass("hidden")})}$(document).ready(function(){0!=$("#catjargon").length&&("onhashchange"in window&&(window.onhashchange=function(){var e=window.location.hash.substr(1),s=$("a[name='"+e+"']").closest(".entry");s.addClass("flash"),setTimeout(function(){s.removeClass("flash")},500)}),$(window).scroll(e),e(),$(".toTop").click(function(){document.location.hash=""}),$("#txtSearch").val(""),$("#txtSearch").bind("input",function(){$(".disclaimer").removeClass("visible"),$("#toggleDisclaimer").removeClass("selected"),$(".glossary-toc").removeClass("visible"),$("#toggleTOC").removeClass("selected"),l()}),""==window.location.hash&&setTimeout(function(){$("#txtSearch").focus()},50),$("#toggleDisclaimer").click(function(e){$(".disclaimer").hasClass("visible")?($(".disclaimer").removeClass("visible"),$("#toggleDisclaimer").removeClass("selected")):($(".disclaimer").addClass("visible"),$(this).addClass("selected"),$(".glossary-toc").removeClass("visible"),$("#toggleTOC").removeClass("selected")),e.preventDefault()}),$("#toggleTOC").click(function(e){$(".glossary-toc").hasClass("visible")?($(".glossary-toc").removeClass("visible"),$("#toggleTOC").removeClass("selected")):($(".disclaimer").removeClass("visible"),$("#toggleDisclaimer").removeClass("selected"),$(".glossary-toc").addClass("visible"),$(this).addClass("selected")),e.preventDefault()}),a())})}();
var JM=JM||{};JM.site=function(){"use strict";function e(){if($(".catSelector span.primary").hasClass("selected"))return void $(".toc-item").removeClass("hidden");var e={};$(".catSelector span.selected").each(function(){e[$(this).text()]=!0}),$(".toc-item").each(function(){var s=[];$(this).find(".filedunder span").each(function(){s.push($(this).text())});for(var a=!1,t=0;t!=s.length;++t){var c=s[t];if(e.hasOwnProperty(c)){a=!0;break}}a?$(this).removeClass("hidden"):$(this).addClass("hidden")})}$(document).ready(function(){var s=localStorage.getItem("cookies");if("munch"!=s){var a="<div class='cookies-wrap'><div class='cookies'><img src='/static/cookiemonster-white.svg' /><div><span class='warning'>Cookies!</span><br /><span class='readMoreCookie'>Grrr?</span><span class='acceptCookie'>Munch</span></div></div></div>";$("body").append(a),$(".readMoreCookie").click(function(){window.location.href="/cookies"}),$(".acceptCookie").click(function(){$(".cookies-wrap").remove(),localStorage.setItem("cookies","munch")})}$(".catSelector span").click(function(s){s.stopPropagation(),$(this).hasClass("primary")?($(".catSelector span").removeClass("selected"),$(this).addClass("selected")):$(".catSelector span.primary").hasClass("selected")?($(".catSelector span.primary").removeClass("selected"),$(this).addClass("selected")):$(this).hasClass("selected")?$(".catSelector span.selected").length>1&&$(this).removeClass("selected"):$(this).addClass("selected"),e()})})}();
var JM=JM||{};JM.locaQuiz=function(){"use strict";var a="",e=0;$(document).ready(function(){if(0!=$("#localizationQuiz").length){var t=localStorage.getItem("locaQuizCount");t||(t=1,localStorage.setItem("locaQuizCount",t)),$(".start").click(function(){$(".start").addClass("hidden"),$(".qpage[data-qix='1']").addClass("active"),$("p.lede").css("display","none"),ga("send",{hitType:"event",eventCategory:"locaquiz",eventAction:"locaquiz-start",eventValue:t}),++t,localStorage.setItem("locaQuizCount",t)}),$(".option").click(function(){var a=$(this).closest(".qpage");a.hasClass("solved")||(a.addClass("solved"),$(this).hasClass("correct")?a.addClass("correct"):a.addClass("false"),$(this).addClass("chosen"))}),$(".continue").click(function(){var t=$(this).closest(".qpage");t.removeClass("active");var s=t.find(".option.chosen"),o=s.data("ox"),i="N";s.hasClass("correct")&&(++e,i="Y");var l=t.data("qix")+1;if(l>2&&(a+="!"),a+=i+"-"+o,l<=10)$(".qpage[data-qix='"+l+"']").addClass("active");else{$("#localizationQuiz .result").addClass("visible");var c="You are<br /> AWESOME";e<3?c="GREAT!<br/>But you're not from this industry,<br/>are you?":e<7&&(c="Not too shabby<br/>AT ALL!"),$(".result .awesome").html(c),$("#locaQuizScore").text(e),ga("send",{hitType:"event",eventCategory:"locaquiz",eventAction:"locaquiz-finish",eventLabel:a,eventValue:e})}})}})}();
var JM=JM||{};JM.lspKeywords=function(){"use strict";function e(){if($(".lspWalkStep").removeClass("visible"),6==m)return void $(".lspKeyWalker").removeClass("visible");var e=".lspWalkStep.step"+m;if($(e).addClass("visible"),$(".lspKeyWalker").addClass("visible"),0==m?($(".walkCommands .next").text("Next"),$(".walkCommands .close").text("Close")):5==m&&($(".walkCommands .next").text("Finish"),$(".walkCommands .close").text("")),$("#lspKeyViz").hasClass("large"))0==m?($(".lspKeyWalker").css("top","10rem"),$(".lspKeyWalker").css("left","4rem"),$(".lspKeyWalker").css("right","")):1==m?($(".lspKeyWalker").css("top","2.5rem"),$(".lspKeyWalker").css("left","2rem")):2==m?($(".lspKeyWalker").css("top","6rem"),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right","2rem")):5==m&&($(".lspKeyWalker").css("top","2.5rem"),$(".lspKeyWalker").css("left","17rem"),$(".lspKeyWalker").css("right",""));else{var s=null;if(0==m){var t=$("#lspKeyChart").position().top+120;$(".lspKeyWalker").css("top",t),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right",""),s=$(".lspKeyWalker").offset(),s.top-=140}else if(1==m){var t=$("#lspKeyChart").position().top+5;$(".lspKeyWalker").css("top",t),$(".lspKeyWalker").css("left","100px")}else if(2==m){var t=$("#lspKeyLegend").position().top;$(".lspKeyWalker").css("top",t+100),$(".lspKeyWalker").css("left","50px"),s=$(".lspKeyWalker").offset(),s.top-=140}else if(5==m){var t=$("#lspKeyChart").position().top+5;$(".lspKeyWalker").css("top",t),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right","20px"),s=$(".lspKeyWalker").offset(),s.top-=140}s&&$("html, body").animate({scrollTop:s.top-100,scrollLeft:s.left})}}function s(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function t(e){for(var s=[],t=0;t!=e.length;++t){for(var l={data:[],backgroundColor:p[t],hoverBackgroundColor:p[t]},a=e[t].data,r=0;r!=a.length;++r){var o=a[r];l.data.push({x:o.x,y:o.y,r:20-Math.round(o.rank/3),tooltip:o.url})}s.push(l)}return s}function l(e){for(var t="ABCDEF",l="",a=0;a!=e.length;++a){var r=e[a];l+="<div class='cluster"+a+" cluster'>",l+="<span class='label'>",l+="Cluster "+t[a]+": "+r.sites.length,l+="</span> ",l+="<b>"+s(r.words)+"</b>",l+="<br/><i>";for(var o=0;o!=r.data.length;++o){var n=r.data[o];0!=o&&(l+=", "),l+="<u>"+(n.rank+1)+"</u>&nbsp;",l+=s(n.url)}l+="</i>",l+="</div>"}$("#lspKeyLegend").html(l)}function a(e,s){$(".cluster"+e+" u:nth-child("+(s+1)+")").addClass("hilite")}function r(e){l(e);var s={datasets:t(e)},r=document.getElementById("lsp-keychart-canvas").getContext("2d");window.lspKeyChart=new Chart(r,{type:"bubble",data:s,options:{responsive:!0,maintainAspectRatio:!1,scales:{xAxes:[{display:!1}],yAxes:[{display:!1}]},legend:{display:!1},tooltips:{callbacks:{label:function(e,s){var t=s.datasets[e.datasetIndex],l=t.data[e.index];return l.tooltip}}},hover:{onHover:function(e){e&&e.length&&0!=e.length?a(e[0]._datasetIndex,e[0]._index):$(".cluster u").removeClass("hilite")}}}})}function o(){var e;e="stemmed"==$("#stem").text()?"stem-":"nostem-",e+=$("#clust2").hasClass("selected")?"2":$("#clust3").hasClass("selected")?"3":$("#clust4").hasClass("selected")?"4":$("#clust5").hasClass("selected")?"5":"6",$("#lspKeyChart canvas").remove(),$("#lspKeyChart").html("<canvas id='lsp-keychart-canvas'></canvas>"),r(d[e])}function n(){o(),$(".ctrl-left").click(function(e){$(".ctrl-left").removeClass("selected"),$(this).addClass("selected"),o(),e.preventDefault()}),$(".ctrl-right").click(function(e){"stemmed"==$(this).text()?$(this).text("surface"):$(this).text("stemmed"),o(),e.preventDefault()})}function i(e,s){var t=new XMLHttpRequest;t.open("GET",e,!0),t.onreadystatechange=function(){4===this.readyState&&200===this.status&&(d[s]=JSON.parse(t.responseText),--y,0==y&&n())},t.send()}function c(){$.ajax({type:"GET",url:"/static/lib/chart-2.1.6.min.js",success:function(){--y,0==y&&n()},dataType:"script",cache:!1})}var p=["#f9bd4e","#50cea8","#a6d5e8","#c493ff","#e1708c","#3eabb4"],d={},y=0,m=0;$(document).ready(function(){0!=$("#lspKeyViz").length&&(y=11,i("/files/lsp-keywords/data-stem-6.json","stem-6"),i("/files/lsp-keywords/data-stem-5.json","stem-5"),i("/files/lsp-keywords/data-stem-4.json","stem-4"),i("/files/lsp-keywords/data-stem-3.json","stem-3"),i("/files/lsp-keywords/data-stem-2.json","stem-2"),i("/files/lsp-keywords/data-nostem-6.json","nostem-6"),i("/files/lsp-keywords/data-nostem-5.json","nostem-5"),i("/files/lsp-keywords/data-nostem-4.json","nostem-4"),i("/files/lsp-keywords/data-nostem-3.json","nostem-3"),i("/files/lsp-keywords/data-nostem-2.json","nostem-2"),c(),$(".ctrl-minimize").click(function(){$("#lspKeyViz").removeClass("large"),$("body").css("overflow-y","scroll"),$("#lspKeyChart canvas").css("height","17rem"),$(".lspKeyWalker").removeClass("visible")}),$(".enlarge").click(function(){$("#lspKeyViz").addClass("large"),$("body").css("overflow-y","hidden"),$("#lspKeyChart canvas").css("height","100% !important"),$(".lspKeyWalker").removeClass("visible")}),$(".walkthrough").click(function(){return $(".lspKeyWalker").hasClass("visible")?void $(".lspKeyWalker").removeClass("visible"):(m=0,void e())}),$(".walkCommands .next").click(function(){++m,e()}),$(".walkCommands .close").click(function(){$(".lspKeyWalker").removeClass("visible")}))})}();
var JM=JM||{};JM.nmt=function(){"use strict";function e(e){$(".nmtBlock .xl").addClass("meta"),$("#xlStraight").text(e?e:"Regular translation"),$("#xlCrazy").text(e?e:"Translation from garbled model")}$(document).ready(function(){$(".nmtHeader .button").click(function(){if(!$(this).hasClass("disabled")){var t=(new Date,$.ajax({url:"https://mtserv.kginno.tk/xlate",type:"POST",contentType:"application/x-www-form-urlencoded; charset=UTF-8",data:{src:$("#txtInput").val()}}));$(".nmtHeader .button").addClass("disabled"),$(".nmtHeader i").addClass("visible"),e(),t.done(function(t){if($(".nmtHeader .button").removeClass("disabled"),$(".nmtHeader i").removeClass("visible"),"ok"==t.status){$("#xlStraight").text(t.real.tgt),$("#xlStraight").removeClass("meta");var a=t.real_sec.toFixed(2)+"s; "+t.real.pred_score.toFixed(2);$("#xlStraight").append("<div class='xlstats'>"+a+"</div>"),$("#xlCrazy").text(t.crazy.tgt),$("#xlCrazy").removeClass("meta"),a=t.crazy_sec.toFixed(2)+"s; "+t.crazy.pred_score.toFixed(2),$("#xlCrazy").append("<div class='xlstats'>"+a+"</div>")}else e("** The server is overloaded. Please try again in a bit. **")}),t.fail(function(t,a,s){$(".nmtHeader .button").removeClass("disabled"),$(".nmtHeader i").removeClass("visible"),e("** Sorry; the service seems to be unavailable right now. **")})}})})}();