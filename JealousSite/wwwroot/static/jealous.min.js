...
"use strict";var JM=JM||{};JM.lspKeywords=function(){function e(){if($(".lspWalkStep").removeClass("visible"),6==d)return void $(".lspKeyWalker").removeClass("visible");var e=".lspWalkStep.step"+d;$(e).addClass("visible"),$(".lspKeyWalker").addClass("visible");var s=null;if(0==d){$(".walkCommands .next").text("Next"),$(".walkCommands .close").text("Close");var t=$("#lspKeyChart").position().top+120;$(".lspKeyWalker").css("top",t),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right",""),s=$(".lspKeyWalker").offset(),s.top-=140}else if(1==d){var t=$("#lspKeyChart").position().top+5;$(".lspKeyWalker").css("top",t),$(".lspKeyWalker").css("left","100px")}else if(2==d){var t=$("#lspKeyLegend").position().top;$(".lspKeyWalker").css("top",t+100),$(".lspKeyWalker").css("left","50px"),s=$(".lspKeyWalker").offset(),s.top-=140}else if(5==d){$(".walkCommands .next").text("Finish"),$(".walkCommands .close").text("");var t=$("#lspKeyChart").position().top+5;$(".lspKeyWalker").css("top",t),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right","20px"),s=$(".lspKeyWalker").offset(),s.top-=140}s&&$("html, body").animate({scrollTop:s.top-100,scrollLeft:s.left})}function s(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function t(e){for(var s=[],t=0;t!=e.length;++t){for(var l={data:[],backgroundColor:i[t],hoverBackgroundColor:i[t]},a=e[t].data,o=0;o!=a.length;++o){var n=a[o];l.data.push({x:n.x,y:n.y,r:20-Math.round(n.rank/3),tooltip:n.url})}s.push(l)}return s}function l(e){for(var t="ABCDEF",l="",a=0;a!=e.length;++a){var o=e[a];l+="<div class='cluster"+a+"'>",l+="<span class='label'>",l+="Cluster "+t[a]+": "+(o.sites.length+1),l+="</span> ",l+="<b>"+s(o.words)+"</b>",l+="<br/><i>";for(var n=0;n!=o.data.length;++n){var r=o.data[n];0!=n&&(l+=", "),l+="<u>"+(r.rank+1)+"</u>&nbsp;",l+=s(r.url)}l+="</i>",l+="</div>"}$("#lspKeyLegend").html(l)}function a(e){l(e);var s={datasets:t(e)},a=document.getElementById("lsp-keychart-canvas").getContext("2d");window.lspKeyChart=new Chart(a,{type:"bubble",data:s,options:{responsive:!0,scales:{xAxes:[{display:!1}],yAxes:[{display:!1}]},legend:{display:!1},tooltips:{callbacks:{label:function(e,s){var t=s.datasets[e.datasetIndex],l=t.data[e.index];return l.tooltip}}}}})}function o(){var e;e="stemmed"==$("#stem").text()?"stem-":"nostem-",e+=$("#clust2").hasClass("selected")?"2":$("#clust3").hasClass("selected")?"3":$("#clust4").hasClass("selected")?"4":$("#clust5").hasClass("selected")?"5":"6",$("#lspKeyChart canvas").remove(),$("#lspKeyChart").html("<canvas id='lsp-keychart-canvas'></canvas>"),a(p[e])}function n(){o(),$(".ctrl-left").click(function(e){$(".ctrl-left").removeClass("selected"),$(this).addClass("selected"),o(),e.preventDefault()}),$(".ctrl-right").click(function(e){"stemmed"==$(this).text()?$(this).text("surface"):$(this).text("stemmed"),o(),e.preventDefault()})}function r(e,s){var t=new XMLHttpRequest;t.open("GET",e,!0),t.onreadystatechange=function(){4===this.readyState&&200===this.status&&(p[s]=JSON.parse(t.responseText),--c,0==c&&n())},t.send()}var i=["#f9bd4e","#50cea8","#a6d5e8","#c493ff","#e1708c","#3eabb4"],p={},c=0,d=0;$(document).ready(function(){0!=$("#lspKeyChart").length&&(c=11,r("/files/lsp-keywords/data-stem-6.json","stem-6"),r("/files/lsp-keywords/data-stem-5.json","stem-5"),r("/files/lsp-keywords/data-stem-4.json","stem-4"),r("/files/lsp-keywords/data-stem-3.json","stem-3"),r("/files/lsp-keywords/data-stem-2.json","stem-2"),r("/files/lsp-keywords/data-nostem-6.json","nostem-6"),r("/files/lsp-keywords/data-nostem-5.json","nostem-5"),r("/files/lsp-keywords/data-nostem-4.json","nostem-4"),r("/files/lsp-keywords/data-nostem-3.json","nostem-3"),r("/files/lsp-keywords/data-nostem-2.json","nostem-2"),$.ajax({type:"GET",url:"/static/lib/chart-2.1.6.min.js",success:function(){--c,0==c&&n()},dataType:"script",cache:!1}),$(".walkthrough").click(function(){return $(".lspKeyWalker").hasClass("visible")?void $(".lspKeyWalker").removeClass("visible"):(d=0,void e())}),$(".walkCommands .next").click(function(){++d,e()}),$(".walkCommands .close").click(function(){$(".lspKeyWalker").removeClass("visible")}))})}();