...
"use strict";var JM=JM||{};JM.locaQuiz=function(){var a="";$(document).ready(function(){0!=$("#localizationQuiz").length&&($(".start").click(function(){$(".start").addClass("hidden"),$(".qpage[data-qix='1']").addClass("active"),$("p.lede").css("display","none")}),$(".option").click(function(){var a=$(this).closest(".qpage");a.addClass("solved"),$(this).hasClass("correct")?a.addClass("correct"):a.addClass("false"),$(this).addClass("chosen")}),$(".continue").click(function(){var s=$(this).closest(".qpage");s.removeClass("active");var t=s.data("qix");a+=""+t,++t,$(".qpage[data-qix='"+t+"']").addClass("active")}))})}();