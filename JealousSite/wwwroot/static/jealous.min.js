...
"use strict";var JM=JM||{};JM.lspKeywords=function(){function e(){if($(".lspWalkStep").removeClass("visible"),6==y)return void $(".lspKeyWalker").removeClass("visible");var e=".lspWalkStep.step"+y;if($(e).addClass("visible"),$(".lspKeyWalker").addClass("visible"),0==y?($(".walkCommands .next").text("Next"),$(".walkCommands .close").text("Close")):5==y&&($(".walkCommands .next").text("Finish"),$(".walkCommands .close").text("")),$("#lspKeyViz").hasClass("large"))0==y?($(".lspKeyWalker").css("top","10rem"),$(".lspKeyWalker").css("left","4rem"),$(".lspKeyWalker").css("right","")):1==y?($(".lspKeyWalker").css("top","2.5rem"),$(".lspKeyWalker").css("left","2rem")):2==y?($(".lspKeyWalker").css("top","6rem"),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right","2rem")):5==y&&($(".lspKeyWalker").css("top","2.5rem"),$(".lspKeyWalker").css("left","17rem"),$(".lspKeyWalker").css("right",""));else{var s=null;if(0==y){var l=$("#lspKeyChart").position().top+120;$(".lspKeyWalker").css("top",l),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right",""),s=$(".lspKeyWalker").offset(),s.top-=140}else if(1==y){var l=$("#lspKeyChart").position().top+5;$(".lspKeyWalker").css("top",l),$(".lspKeyWalker").css("left","100px")}else if(2==y){var l=$("#lspKeyLegend").position().top;$(".lspKeyWalker").css("top",l+100),$(".lspKeyWalker").css("left","50px"),s=$(".lspKeyWalker").offset(),s.top-=140}else if(5==y){var l=$("#lspKeyChart").position().top+5;$(".lspKeyWalker").css("top",l),$(".lspKeyWalker").css("left",""),$(".lspKeyWalker").css("right","20px"),s=$(".lspKeyWalker").offset(),s.top-=140}s&&$("html, body").animate({scrollTop:s.top-100,scrollLeft:s.left})}}function s(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function l(e){for(var s=[],l=0;l!=e.length;++l){for(var t={data:[],backgroundColor:c[l],hoverBackgroundColor:c[l]},a=e[l].data,r=0;r!=a.length;++r){var o=a[r];t.data.push({x:o.x,y:o.y,r:20-Math.round(o.rank/3),tooltip:o.url})}s.push(t)}return s}function t(e){for(var l="ABCDEF",t="",a=0;a!=e.length;++a){var r=e[a];t+="<div class='cluster"+a+" cluster'>",t+="<span class='label'>",t+="Cluster "+l[a]+": "+(r.sites.length+1),t+="</span> ",t+="<b>"+s(r.words)+"</b>",t+="<br/><i>";for(var o=0;o!=r.data.length;++o){var n=r.data[o];0!=o&&(t+=", "),t+="<u>"+(n.rank+1)+"</u>&nbsp;",t+=s(n.url)}t+="</i>",t+="</div>"}$("#lspKeyLegend").html(t)}function a(e){t(e);var s={datasets:l(e)},a=document.getElementById("lsp-keychart-canvas").getContext("2d");window.lspKeyChart=new Chart(a,{type:"bubble",data:s,options:{responsive:!0,maintainAspectRatio:!1,scales:{xAxes:[{display:!1}],yAxes:[{display:!1}]},legend:{display:!1},tooltips:{callbacks:{label:function(e,s){var l=s.datasets[e.datasetIndex],t=l.data[e.index];return t.tooltip}}}}})}function r(){var e;e="stemmed"==$("#stem").text()?"stem-":"nostem-",e+=$("#clust2").hasClass("selected")?"2":$("#clust3").hasClass("selected")?"3":$("#clust4").hasClass("selected")?"4":$("#clust5").hasClass("selected")?"5":"6",$("#lspKeyChart canvas").remove(),$("#lspKeyChart").html("<canvas id='lsp-keychart-canvas'></canvas>"),a(p[e])}function o(){r(),$(".ctrl-left").click(function(e){$(".ctrl-left").removeClass("selected"),$(this).addClass("selected"),r(),e.preventDefault()}),$(".ctrl-right").click(function(e){"stemmed"==$(this).text()?$(this).text("surface"):$(this).text("stemmed"),r(),e.preventDefault()})}function n(e,s){var l=new XMLHttpRequest;l.open("GET",e,!0),l.onreadystatechange=function(){4===this.readyState&&200===this.status&&(p[s]=JSON.parse(l.responseText),--d,0==d&&o())},l.send()}function i(){$.ajax({type:"GET",url:"/static/lib/chart-2.1.6.min.js",success:function(){--d,0==d&&o()},dataType:"script",cache:!1})}var c=["#f9bd4e","#50cea8","#a6d5e8","#c493ff","#e1708c","#3eabb4"],p={},d=0,y=0;$(document).ready(function(){0!=$("#lspKeyViz").length&&(d=11,n("/files/lsp-keywords/data-stem-6.json","stem-6"),n("/files/lsp-keywords/data-stem-5.json","stem-5"),n("/files/lsp-keywords/data-stem-4.json","stem-4"),n("/files/lsp-keywords/data-stem-3.json","stem-3"),n("/files/lsp-keywords/data-stem-2.json","stem-2"),n("/files/lsp-keywords/data-nostem-6.json","nostem-6"),n("/files/lsp-keywords/data-nostem-5.json","nostem-5"),n("/files/lsp-keywords/data-nostem-4.json","nostem-4"),n("/files/lsp-keywords/data-nostem-3.json","nostem-3"),n("/files/lsp-keywords/data-nostem-2.json","nostem-2"),i(),$(".ctrl-minimize").click(function(){$("#lspKeyViz").removeClass("large"),$("body").css("overflow-y","scroll"),$("#lspKeyChart canvas").css("height","17rem"),$(".lspKeyWalker").removeClass("visible")}),$(".enlarge").click(function(){$("#lspKeyViz").addClass("large"),$("body").css("overflow-y","hidden"),$("#lspKeyChart canvas").css("height","100% !important"),$(".lspKeyWalker").removeClass("visible")}),$(".walkthrough").click(function(){return $(".lspKeyWalker").hasClass("visible")?void $(".lspKeyWalker").removeClass("visible"):(y=0,void e())}),$(".walkCommands .next").click(function(){++y,e()}),$(".walkCommands .close").click(function(){$(".lspKeyWalker").removeClass("visible")}))})}();